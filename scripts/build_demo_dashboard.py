...
<html lang="en"><head>
  ...
  <header><div class="hero-copy"><div class="kicker">Local-first · evidence-linked · human-gated</div><h1>Working demo.</h1><p>One source trail becomes a reviewable brief, script, narration, visual system, captions, and playable video without a paid API call.</p><span class="lock">External publishing locked</span></div><div class="hero-art"><div>CAPTURE</div><div>CURATE</div><div>CREATE</div><div>CONTROL</div></div></header>
  ...
  <section class="two"><article class="card"><h2>What is real</h2><p>The object IDs, provenance links, claim policy, lifecycle transitions, narration, visuals, captions, MP4, and audit history are generated artifacts on this machine. No product footage or synthetic hands-on claim is used.</p></article><article class="card"><h2>What stays gated</h2><p>YouTube, LinkedIn, public hosting, affiliate links, and paid generation remain disabled until the local result is worth publishing and all freshness-sensitive facts are checked.</p></article></section>
